...
def main():
    ...
    menu.add_action("Calculate Work Hours for Today", lambda: manager.calculate_work_hours(date_input("today")))
    menu.add_action("Calculate Work Hours for Specific Date", lambda: manager.calculate_work_hours(date_input()))
